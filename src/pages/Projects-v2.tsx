...
export function ProjectsSection() {
  ...
  return (
    <div id="projects" className="relative">
      <div className="absolute -top-5 left-0 w-full h-60 bg-gradient-to-b from-[#020202] to-transparent pointer-events-none z-10" />

      {/* Section Header — scrolls normally */}
      <div className="px-6 pt-10 pb-6 relative z-20">
        <div className="mx-auto max-w-2xl lg:max-w-6xl">
          ...
          >
            ...
            <motion.p
              ...
              className="mt-4 max-w-2xl text-xs lg:text-lg text-muted-foreground"
            >
      ...
      {/* Carousel wrapper — sticky kicks in when this reaches viewport top */}

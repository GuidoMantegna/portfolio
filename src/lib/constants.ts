...
export const PROJECTS_INFO: ProjectInfo[] = [
  ...
  },
  {
    id: 2,
    title: "AAP - Dashboard",
    subtitle: "Adictos Al Padel Analytics",
    description: "• Analytics dashboard for a padel event management platform, providing real-time insights into player activity, events, and website traffic.",
    longDescription: "• Analytics dashboard for a padel event management platform, providing real-time insights into player activity, events, and website traffic. It features time-based filtering, accessible themes, and integrates Supabase RPC functions with Vercel Analytics.",
    tags: ["Next.js", "Recharts", "Vercel Analytics", "Supabase RPC"],
    features: ["50+ Components", "WCAG 2.1 Compliant", "Tree Shakeable", "Dark Mode Support"],
    link: "https://dashboard.adictosalpadel.app/",
    github: "",
